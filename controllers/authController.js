...
module.exports.register = async (req, res, next) => {
  const { username, fullName, email, password, city, dayOBD, monthOBD, yearOBD } = req.body;
  let user = null;
  ...
  try {
    user = new User({ username, fullName, email, password, city, dayOBD, monthOBD, yearOBD });
